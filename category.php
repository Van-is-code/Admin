...
<?php require_once ("./view/navbar.php") ; ?>
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<td>
                ...
                <a href="products/detail.php?id=' . $row['id'] . '"  id="tooltip" class="btn_detail" ><img class="icon" width="40" height="40" src="./img/details.png"> <span class="tooltiptext">Detail</span></a>
                </td>';
