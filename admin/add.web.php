...
if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $admin_id = "Admin" . rand(0, 1000);
    ...
    $sql = "INSERT INTO `user` (`admin_id`,`first_name`,`last_name`,`email`, `phone`, `password`,`role`,`image`, `time_update`) "
    . " VALUES ('$admin_id ', '$first', '$last','$email','$phone','$password','$role','$image', '$timeUpdate');";
