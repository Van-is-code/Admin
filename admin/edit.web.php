...
if(isset($_GET['id'])) {
  ...
  if(isset($_POST['edit_admin'])) {
    ...
    $update = "UPDATE `admin` SET `firstname`=IF('$first'='', `firstname`, '$first'), `lastname`=IF('$last'='', `lastname`, '$last'), `email`=IF('$email'='', `email`, '$email'), `password`=IF('$password'='', `password`, '$password'),  `updated_at`=IF('$timeUpdate'='', `updated_at`, '$timeUpdate') WHERE `id`='$id';";
...
<div class="card shadow">
                        ...
                        <p class="text-primary m-0 fw-bold">Edit Admin </p>
                              </div>
                                 <div class="card-body">
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="password" id="password" placeholder="password">
      ...
      <div style="width: 16%;margin-left: 45%;margin-bottom: 5%;margin-top: 5%;">
        <input class="btn btn-primary" type="submit" name="edit_admin" value="Edit Admin"/>
      </div>
