...
include_once dirname(__FILE__) . '/auth/auth.php'; 
 require_once ("./view/navbar.php") ; ?>
                ...
                <a id="tooltip" class="btn_add" href="./auth/clearSession.php"><i class="fas fa-sign-out-alt"></i><span class="tooltiptext">Exit</span></a>

                    <div class="card shadow">
                        <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Admin</p>
                             <button id="tooltip" class="btn_add" type="button" onclick="addAdmin()"><img class="icon" width="30" height="30" src="./img/add.png"> <span class="tooltiptext">Add</span></button>
